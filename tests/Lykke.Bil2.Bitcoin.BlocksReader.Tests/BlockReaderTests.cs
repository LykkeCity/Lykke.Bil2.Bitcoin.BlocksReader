...
namespace Lykke.Bil2.Bitcoin.BlocksReader.Tests
{
    ...
    public class BlockReaderTests
    {
        ...
        private readonly Mock<IBlockTransactionsListener> _transactionsListenerMock;
        ...
        public async Task Can_Parse_Block()
        {
            ...
            _blockListenerMock.Verify(x => x.StartBlockTransactionsHandling(
            ...
            _blockListenerMock.Verify(x => x.HandleRawBlock(
            ...
            _transactionsListenerMock.Verify(x => x.HandleRawTransactionAsync(
                    It.Is<Base64String>(p => p.DecodeToBytes().SequenceEqual(tx1Bytes)),
                    It.Is<TransactionId>(p => p == "ba938c9f5188956f0a36e01e6878c5bc98c3c2e9dcb2209898bf03115fa72537")),
                Times.Once);
            _transactionsListenerMock.Verify(x => x.HandleExecutedTransaction(
                    It.Is<TransferCoinsExecutedTransaction>(p =>
            ...
            _transactionsListenerMock.Verify(x => x.HandleRawTransactionAsync(
                    ...
                    It.Is<TransactionId>(p => p == "88a5407783a2ca99b0dad75624aaefdd9c1f7a092ea63d5ec93d48fc4d49c4ed")),
                Times.Once);
            ...
            _transactionsListenerMock.Verify(x => x.HandleRawTransactionAsync(
                    ...
                    It.Is<TransactionId>(p => p == "561563fb5321d2805540e388b3f41f0067447833fba4311429588987a348ba54")),
                Times.Once);
            _transactionsListenerMock.Verify(x => x.HandleExecutedTransaction(
                    It.Is<TransferCoinsExecutedTransaction>(
                        p => p.TransactionNumber == 2 &&
            ...
            _transactionsListenerMock.Verify(x => x.HandleRawTransactionAsync(
                    ...
                    It.Is<TransactionId>(p => p == "2e9dc9e1e5ac5b8839018b490de942f1992bb8f3dd90eb93c5ecd69cdafbe6f4")),
                Times.Once);
            _transactionsListenerMock.Verify(x => x.HandleExecutedTransaction(
                It.Is<TransferCoinsExecutedTransaction>(p => p.TransactionId == "2e9dc9e1e5ac5b8839018b490de942f1992bb8f3dd90eb93c5ecd69cdafbe6f4")),
                Times.Once);
